...
public class PedidoModel {
    ...
    public PedidoViewDTO toPedidoView(){
        List<ProdutoViewDTO> produtosViewDTO = this.produtos.stream().map(ProdutoModel::toProdutoViewDTO).toList();
        return new PedidoViewDTO(codigo, dataCadastro, valorTotal, valorDesconto, valorPagamento, clienteModel.toClienteViewDTO(), produtosViewDTO);
    }
}
